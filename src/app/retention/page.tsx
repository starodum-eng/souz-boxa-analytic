    ...
    <div className="container">
      <div className="header">
        ...
        <div className="controls">
          <a href="/" className="sync-btn" style={{ textDecoration: "none", display: "inline-flex", alignItems: "center" }}>
            ← К дашборду
          </a>
        </div>
      </div>
      ...
      {data && (
        <>
          ...
          <div className="section-title">
            📞 Кому звонить · заканчиваются / истекли ({data.callList.length})
          </div>
          <div className="card">
            <table>
              <thead>
          ...
          <div className="section-title">
            🚪 Не ходят · активный абонемент, нет визитов 14+ дней ({data.atRisk.length})
          </div>
          <div className="card">
            <table>
              <thead>
